...
const newCode = [
  ...
  'msg:"<div style=\\"text-align:left;padding:10px 0\\"><label style=\\"display:block;margin:8px 0;font-size:13px;cursor:pointer\\"><input type=\\"checkbox\\" checked id=\\"epub-opt-toc\\" style=\\"margin-right:8px\\"/>Include generated Table of Contents</label><label style=\\"display:block;margin:8px 0;font-size:13px;cursor:pointer\\"><input type=\\"checkbox\\" checked id=\\"epub-opt-fonts\\" style=\\"margin-right:8px\\"/>Embed fonts</label><label style=\\"display:block;margin:8px 0;font-size:13px;cursor:pointer\\"><input type=\\"checkbox\\" id=\\"epub-opt-chapters\\" style=\\"margin-right:8px\\"/>Chapter-based splitting</label></div>",',
  'buttons:["ok","cancel"],',
  'primary:"ok",',
  'callback:function(r){',
  'if(r=="ok"){',
